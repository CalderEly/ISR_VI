...
batch_size = 64
max_batches = 20  # break early for first validation pass
num_epochs = 1
...
optimizer = torch.optim.Adam([hidden_layer.W, output_layer.W], lr=0.001)
...
if __name__ == '__main__':
    for epoch in range(num_epochs):
        ...
        print(f'Finished epoch {epoch} after {min(len(loader), max_batches)} batches')
